...
public class MaleAdapter  extends RecyclerView.Adapter<MaleAdapter.ViewHolderMale> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull ViewHolderMale holder, final int position) {
        ...
        holder.tvIdMale.setText("ID: "+male.getIdMale());
        holder.tvRaceMale.setText(""+male.getRace());
        holder.tvConformacionFisica.setText(male.getConformacionFisica());
    ...
    public class ViewHolderMale extends RecyclerView.ViewHolder {
        ...
        private TextView tvIdMale;
        private TextView tvRaceMale;
        private TextView tvConformacionFisica;
        private LinearLayout llCardviewMale;

        public ViewHolderMale(@NonNull View itemView) {
            super(itemView);
            tvIdMale =  itemView.findViewById(R.id.tv_id_male);
            tvRaceMale =  itemView.findViewById(R.id.tv_raceMale);
            tvConformacionFisica = itemView.findViewById(R.id.tv_conformacionFisica);
